label Dia2_Raul_Priscila:
    ...
    "Eu estou impressionado porque nem mesmo se eu tivesse que madrugar para fazer dois trabalhos e estudar para uma prova para o dia seguinte eu conseguiria dormir num chão de concreto, no meio de um pátio e com um monte de gente olhando."

    "Olhando para outro lado, noto uma energia completamente oposta. Vejo Raul, alguém com uma enorme disposição para organizar o festival do centro comunitário. Ele passa pelo pátio cumprimentando a todos e verificando as ideias para o festival. Logo em seguida, percebo que Raul se move em direção ao enrolado de cobertor e essas duas energias contrastantes iriam entrar em conflito. Algo vai acontecer."
    ...
    *Cutuca* *Cutuca*"
    ...
    Ren "Parece que o comentário surtiu algum efeito."
...
label Cena_Dia2RaulPriscila_Escolha_1_b:
    ...
    Raul "Ok, ok. Enfim, vamos focar no assunto do dia, galera."
