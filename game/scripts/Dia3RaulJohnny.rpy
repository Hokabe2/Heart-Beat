...
label Dia3_RaulJohnny_Escolha_1_continuacao:
    ...
    Raul "He, he, he. Palavra dita, palavra cumprida."

    Raul "Tudo começou quando..."
    ...
    Raul "Pelo... Antigo valentão do centro comunitário que saiu da cidade há alguns anos."

    "Definitivamente o Raul me deixou curioso para saber a parte dessa história que ele está escondendo."
